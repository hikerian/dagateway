...
public class SingleServiceBroker<P extends Publisher<Cq>, Cq, Sr> implements ServiceBroker<P, Cq, Sr> {
	...
	public SingleServiceBroker(RouteContext routeContext, ClientRequestResolver<P, Cq> requestResolver, ClientResponseResolver<Mono<ServiceResult<Sr>>, Sr> responseResolver) {
