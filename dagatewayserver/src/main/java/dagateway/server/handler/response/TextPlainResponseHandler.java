...
public class TextPlainResponseHandler extends AbstractServiceResponseHandler<Mono<String>, String, String> {
	private final Logger log = LoggerFactory.getLogger(TextPlainResponseHandler.class);
	
	private byte[] remainBytes = null;
	
	
	public TextPlainResponseHandler() {
	}

	@Override
	protected Mono<String> resolveBody(Flux<DataBuffer> responseBody) {
	...
	@Override
	public Mono<ServerResponse> buildBody(BodyBuilder builder, Mono<String> body) {
		return builder.body(BodyInserters.fromProducer(body, String.class));
	}
