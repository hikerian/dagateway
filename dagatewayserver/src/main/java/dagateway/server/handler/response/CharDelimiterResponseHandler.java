...
public class CharDelimiterResponseHandler extends AbstractServiceResponseHandler<Flux<DataBuffer>, String, String> {
	private final Logger log = LoggerFactory.getLogger(CharDelimiterResponseHandler.class);	
	...
	public CharDelimiterResponseHandler() {
	}
