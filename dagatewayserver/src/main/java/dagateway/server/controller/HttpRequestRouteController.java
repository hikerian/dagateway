...
public class HttpRequestRouteController {
	...
	@Autowired
	private ServiceBrokerBuilder serviceBrokerBuilder;
	
	
	public HttpRequestRouteController() {
	}
	
	public void setServiceBrokerBuilder(ServiceBrokerBuilder serviceBrokerBuilder) {
